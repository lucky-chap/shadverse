...
export const metadata: Metadata = {
  title: "Awesome AWS",
  description:
    "AwesomeAWS is the ultimate destination for developers and businesses seeking discover an extensive collection of applications built with AWS technologies",
};
  ...
  return (
    <section>
      ...
      <div className="flex w-full max-w-2xl mx-auto items-center space-x-2">
        <Input
          className="bg-zinc-950 border-zinc-900 text-zinc-300 focus-visible:ring-zinc-950"
          type="email"
